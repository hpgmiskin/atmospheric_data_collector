import os;
# Django settings for atmospheric_data_collector project.
...
STATIC_ROOT = os.path.join(ROOT,"atmospheric_data_collector/assets")
...
SECRET_KEY = '8qr($96d$m*a=(wi-tisqi$6)(fb8y5(n42$=95fau&ped69sd'
...
ROOT_URLCONF = 'atmospheric_data_collector.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'atmospheric_data_collector.wsgi.application'
